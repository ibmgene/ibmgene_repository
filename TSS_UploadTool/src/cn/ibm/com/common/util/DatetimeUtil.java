...
public class DatetimeUtil {
	...
	public static final Date getPreDate(String endDate,int day) {
		...
		try {
			Date date = convertStringToDate("yyyy-MM-dd HH:mm:ss", locale,
					null, endDate + " 00:00:00");
			return new Date(date.getTime() - (long)24 * 3600 * 1000 * day);
		} catch (Exception e) {
			return null;
		}
	}
	...
	public final static String getFormatDate(Date date,String style){
