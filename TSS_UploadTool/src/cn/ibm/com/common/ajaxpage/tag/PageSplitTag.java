package cn.ibm.com.common.ajaxpage.tag;
...
public class PageSplitTag extends TagSupport {
	...
	private int pageSize = GaotimeConstants.PAGE_SIZE_DEFAULT; // 每一页面显示的最大记录数
	...
	public int doEndTag() throws JspException {
		...
		reStr.append("<form name='splitPageForm' method='post' id='splitForm'");
		reStr.append("action='" + url + addParams(paramsStr) + "'>");
		reStr.append("<table align=\"right\" style=\"font-size:12px;\"><tr>");
		reStr.append("<td><font color='#10497d'>第<b>" + intPageNo + "/"
				+ totalPages + "</b>页");
		...
		reStr.append("<input class=\"txtout\" id=\"slcpageInput\" style=\"display:none;width:37px\" type=\"text\"></td>");
		...
		if(totalPages>2){
			...
			reStr.append("</td><td><img src='images/btn-goto.gif' style='cursor:pointer' onclick='splitForm.submit()' />");
		}
